...
<table border=0 width=100%>
  <tr>
    ...
    <td width="520"align="center">Mengetahui <br> Kepala SMPTK Budi Mulia</td>
    <td width="260" align="left">Gresik, <?php echo tgl_raport(date("Y-m-d")); ?> <br> Wali Kelas</td>
  </tr>
  <tr>
    ...
    <td align="center" valign="top"><br /><br /><br /><br /><br />
      <b>Ruth Faradella Meylianna, Br. S. S.Pd<br>
